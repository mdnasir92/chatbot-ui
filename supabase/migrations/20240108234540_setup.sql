...
AS $$
DECLARE
  project_url TEXT := 'ttps://iwlfwxumfkqwnyqxzhnm.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml3bGZ3eHVtZmtxd255cXh6aG5tIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTkxNjUwOCwiZXhwIjoyMDYxNDkyNTA4fQ.URmiRC2YY91ltjQzcrmY2tFooUMCnO9WtUx-GMCR7Jg'; -- full access needed for http request to storage
